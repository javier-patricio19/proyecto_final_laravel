                            ...
                            <div class="flex space-x-4">
                                ...
                                @if (Auth::user() != null && Auth::user()->tipo == 1)
                                    <a href="{{ route('mostrarUsuarios') }}"
                                        class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Usuarios</a>
                                    <a href="{{ route('mostrarContrataciones') }}"
                                        class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Contrataciones</a>
                                @endif
                            </div>
                        </div>
                    </div>
